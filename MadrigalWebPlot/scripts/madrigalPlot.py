...
class madScatterPlot:
    ...
    def __init__(self, isprintText,
        ...
        try:
            ...
            float_data = list(map(lambda i : self.__filter_missing(split_data[i]), range(len(split_data))))            
...
class madPcolorPlot:
    ...
    def __init__(self, isprintText,
        ...
        matplotlib.pylab.pcolor(X,Y,Z, edgecolors='None', vmin=minColormap, vmax=maxColormap, cmap = colorMap, norm = matplotlib.pylab.Normalize())
